...
# optimize for size
set(CMAKE_C_FLAGS_INIT "-mmcu=atmega328p -Wall -Os -fno-rtti -fno-exceptions -ffreestanding -fno-use-cxa-atexit -fno-threadsafe-statics")
set(CMAKE_CXX_FLAGS_INIT "-mmcu=atmega328p -Wall -Os -fno-rtti -fno-exceptions -ffreestanding -fno-use-cxa-atexit -fno-threadsafe-statics")
